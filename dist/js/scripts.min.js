"use strict";!function(t){t(document).ready(function(a){t(".material-button").click(function(a){t(a.target).hasClass("material-button--close")?(t(".cv-modal").each(function(){t(this).css("display","none")}),t("body").removeClass("cv-modal--active")):(t('.cv-modal[data-modal="'+t(a.target).data("modal")+'"').css("display","block"),t("body").addClass("cv-modal--active"))})})}(jQuery);
