"use strict";!function(s){s(document).ready(function(a){function e(){s(".material-navigation").removeClass("menu--active")}s(".material-button").click(function(a){var t;s(a.target).hasClass("material-button--back")?(s(".cv-modal").each(function(){s(this).hasClass("cv-modal--active")&&s(this).removeClass("cv-modal--active")}),s("body").removeClass("cv-modal--active")):s(a.target).hasClass("material-button--menu")?s(".material-navigation").addClass("menu--active"):(s(a.target).hasClass("material-button--close-menu")||(t='.cv-modal[data-modal="'+s(a.target).data("modal")+'"]',s(t).addClass("cv-modal--active"),s("body").addClass("cv-modal--active")),e())})})}(jQuery);
